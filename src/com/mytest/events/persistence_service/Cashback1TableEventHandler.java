...
{
    @Override
    public void beforeUpdate(RunnerContext context, Cashback cashback1 ) throws Exception
    {
        // update not allowed from app - return exception
        // beforeUpdate is not called, if update is done from server code
        throw new BackendlessException(BackendResponseCodes.BE_ERROR_OPERATION_NOT_ALLOWED, "Cashback table update not allowed");
    }
}
